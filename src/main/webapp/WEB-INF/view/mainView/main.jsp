                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="w-25" id="base-map-btn" style="background-color: #293661; color: white;">
                                            기본</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="dropdown" colspan="3">
                                            <select class="col-12" name="car_num" id="car_num">
                                                <option value="103하2414" class="text-center">103하2414</option>
                                                <option value="114하6585" class="text-center">114하6585</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <!-- <div class='rap'> -->
                                                <!-- <div class="header">
                                                    <div class="calendar-btn prevDay"></div>
                                                    <div class='dateTitle fs-5' id="dateTitle"></div>
                                                    <div class="calendar-btn nextDay"></div>
                                                </div>
                                            ...
                                            <!-- </div> -->
                                            <!-- <div type="text" class="calendar-date input-group fs-6" id="datepicker">
